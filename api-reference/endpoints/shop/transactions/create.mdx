...
<Info>
This is the primary endpoint for **e-commerce integrations** (WooCommerce, Shopify, etc.) to award and redeem points. It requires Partner API authentication.
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="Get Card Info" icon="id-card" href="/api-reference/endpoints/shop/loyalty-cards/info">
