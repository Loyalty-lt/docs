---
title: "Get Partner Card"
api: "GET /{locale}/shop/partner-cards/{id}"
...
```
GET /{locale}/shop/partner-cards/{id}
```
...
```bash cURL
curl -X GET "https://staging-api.loyalty.lt/en/shop/partner-cards/5" \
