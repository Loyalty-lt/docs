...
Instant customer identification system for POS terminals and kiosks.

**Features:**
- Display QR code on POS screen
- Customer scans with Loyalty.lt mobile app
- Instant card data returned via WebSocket (no confirmation needed)
...
- `POST /{locale}/shop/qr-card/ably-token` - Get Ably WebSocket token
