...
<CardGroup cols={3}>
  ...
  <Card title="SMS API" icon="message" href="/api-reference/endpoints/sms/overview">
...
The SMS API allows partners to send SMS messages programmatically with automatic billing, delivery tracking, and webhook notifications.
...
<Card title="SMS API Documentation" icon="arrow-right" href="/api-reference/endpoints/sms/overview">
