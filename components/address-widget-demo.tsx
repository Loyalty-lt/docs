 ...
 *
 * `embedded` renkamas maršrutu, ne URL parametru: parametras matomas tik po
 * hidratacijos, tad iframe'e trumpam blykstelėtų antraštė ir įdiegimo pavyzdys,
 * kurie ten nepriklauso.
 *
...
export function AddressWidgetDemo({ embedded = false }: { embedded?: boolean }) {
